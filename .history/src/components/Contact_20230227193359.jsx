...
<form action="" className='flex flex-col max-w-[600px] w-full'>
    <div className='pb-8'>
        ...
        <input className=' my-6 p-4 bg-[#ccd6f6] rounded-lg' type="text" placeholder='Name' name='name' />
        <input className='my-6 p-2 bg-[#ccd6f6] rounded-lg' type="text" placeholder='Email' name='email' />
