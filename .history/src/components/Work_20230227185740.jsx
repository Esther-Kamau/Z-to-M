...
React-JS Application
                        ...
                        <div>
                            <a href="/">
                               <button className='text-center rounded-lg px-4 py-3 m-2 bg-purple-300 font-bold text-l'>Demo</button> 
                            </a>
                            <a href="/">
                               <button className='text-center rounded-lg px-4 py-3 m-2 bg-purple-300 font-bold text-l'>Code</button> 
                            </a>
                        </div>
